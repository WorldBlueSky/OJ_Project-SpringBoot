...
public class UserController extends BaseController{
    ...
    public Map<String, Object> register(String username, String password,String required) throws InsertException, UsernameDuplicatedException {
...
//        System.out.println(required);
    ...
    public Map<String, Object> loginByUser(String username, String password, HttpServletRequest request) throws PasswordNotMatchException, UsernameNotFoundException {
    ...
    public Map<String,Object> sendCode(@RequestParam(value = "phone") String phone) {
...
//        System.out.println(phone);
    ...
    @RequestMapping("/phoneLogin")
     public Map<String,Object> phoneLog(String phone,String code,HttpSession session){
        HashMap<String,Object> map =new HashMap<>();
